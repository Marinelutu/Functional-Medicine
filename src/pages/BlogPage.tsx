...
const articles = [
  { slug: "cortisol-sabotaging-weight-loss", title: "Why Your Cortisol Is Sabotaging Your Weight Loss", category: "Weight Loss", readTime: "6 min", excerpt: "Chronic stress doesn't just make you tired — it actively prevents fat loss." },
  { slug: "gut-brain-axis-explained", title: "The Gut-Brain Axis Explained", category: "Gut Health", readTime: "7 min", excerpt: "Your gut produces 90% of your serotonin. Here's why that matters." },
  { slug: "5-lab-tests-doctor-never-orders", title: "5 Lab Tests Your Doctor Never Orders But Should", category: "Functional Medicine", readTime: "5 min", excerpt: "These overlooked markers reveal root causes that standard panels miss." },
  { slug: "seed-cycling-hormone-balance", title: "Seed Cycling for Hormone Balance: Does It Actually Work?", category: "Hormones", readTime: "6 min", excerpt: "The science behind this trending protocol — and how to do it right." },
  { slug: "metabolic-flexibility", title: "What Is Metabolic Flexibility and Why Should You Care?", category: "Weight Loss", readTime: "7 min", excerpt: "The ability to switch between fuel sources is the key to sustainable energy." },
  { slug: "leaky-gut-real", title: "Is Leaky Gut Real? What the Science Actually Says", category: "Gut Health", readTime: "8 min", excerpt: "Intestinal permeability is well-documented — here's what causes it and how to heal." },
  { slug: "nad-longevity", title: "NAD+ and the Future of Longevity Medicine", category: "Longevity", readTime: "9 min", excerpt: "This coenzyme declines with age. Restoring it may be the key to healthspan." },
  { slug: "brain-fog-not-normal", title: "Brain Fog Is Not Normal — Here's What's Causing It", category: "Mental Clarity", readTime: "6 min", excerpt: "From neuroinflammation to blood sugar crashes, the real reasons you can't think clearly." },
  { slug: "functional-medicine-vs-conventional", title: "Functional Medicine vs. Conventional: What's the Difference?", category: "Functional Medicine", readTime: "5 min", excerpt: "One treats symptoms. The other asks why. Here's how to choose." },
];
      ...
      <section className="pt-28 pb-12">
        <div className="container mx-auto px-6">
          <Link to={`/blog/${featuredArticle.slug}`} className="grid lg:grid-cols-2 gap-10 items-center group">
            <ImagePlaceholder label="[IMAGE: Blog featured — Thyroid article cover]" aspectRatio="landscape" className="rounded-2xl" />
            <div>
